...
public class DClass extends  EnemyTypo  implements Comparable<EnemyTypo>{
	...
	public DClass(double xPos, double yPos, int rows, int columns){
		
		enemySprite = new SpriteAnimation(xPos, yPos, rows, columns, 300, "/Img/Mang.png");
