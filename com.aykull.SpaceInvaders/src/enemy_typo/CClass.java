...
public class CClass extends  EnemyTypo  implements Comparable<EnemyTypo>{
	...
	public CClass(double xPos, double yPos, int rows, int columns){
		
		enemySprite = new SpriteAnimation(xPos, yPos, rows, columns, 300, "/Img/Chimmy.png");
