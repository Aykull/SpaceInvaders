...
public class EClass extends  EnemyTypo  implements Comparable<EnemyTypo>{
	...
	public EClass(double xPos, double yPos, int rows, int columns){
		
		enemySprite = new SpriteAnimation(xPos, yPos, rows, columns, 300, "/Img/Koya.png");
