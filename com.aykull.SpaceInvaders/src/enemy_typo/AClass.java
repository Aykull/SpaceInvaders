...
public class AClass extends  EnemyTypo  implements Comparable<EnemyTypo> {
private double speed = 1.0d; 
	...
	public AClass(double xPos, double yPos, int rows, int columns){
		
		enemySprite = new SpriteAnimation(xPos, yPos, rows, columns, 300, "/Img/Cooky.png");
