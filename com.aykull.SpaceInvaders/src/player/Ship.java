...
public class Ship  implements KeyListener{
	...
	public static boolean left = false, right = false, shoot = false;
	...
	public Ship(double xPos, double yPos, int width, int height){
		...
		try{
			URL url = this.getClass().getResource("/Img/van.png");
	...
	public void update(double delta){
		...
		if(shoot){
			playerWeapon.shootBullet(xPos, yPos, 5, 5);
		}
	}
